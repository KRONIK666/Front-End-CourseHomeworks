...
function JavaScript10() {
	...
	document.getElementById("task").innerHTML = "10. Напишете скрипт, който намира най-често срещаното число в седния масив: [0, 4, 1, 3, 4, 6, 3, 4, 9, 9, 4, 1, 4]";
	document.getElementById("result").innerHTML = "NOT SOLVED YET!";
}

function JavaScript11() {
	var today = new Date();
...
function JavaScript12() {

	document.getElementById("task").innerHTML = "12. Напишете скрипт, който създава обект student, който има следните свойства: име, години, опит, оценка, функция учене, функция забавление.";
	document.getElementById("result").innerHTML = "NOT SOLVED YET!";
}

function JavaScript13() {

	document.getElementById("task").innerHTML = "13. Използвайки Task 12, изпишете всички свойства и функции на вече създадения обект student.";
	document.getElementById("result").innerHTML = "NOT SOLVED YET!";
}

function JavaScript14() {

	document.getElementById("task").innerHTML = "14. Напишете функция, която при извикването си сменя съдържанието на елемент по избор.";
	document.getElementById("result").innerHTML = "NOT SOLVED YET!";
}

function JavaScript15() {

	document.getElementById("task").innerHTML = "15. Направете страница, която съдържа елемент картинка, представляваща несветеща крушка. Напишете скрипт, който при hover върху крушката, сменя src-то на крушката и тя „светва“.";
	document.getElementById("result").innerHTML = "NOT SOLVED YET!";
}